export default function Pricing() {
  ...
  return (
    <section id="pricing" className="section-padding bg-[var(--deep)] relative border-y border-[rgba(0,212,255,0.1)]">
      ...
      <div className="section-inner relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto items-center">
          ...
          {/* Weekday Tier */}
          <div className="rv d2 bg-gradient-to-br from-[var(--abyss)] to-[var(--deep)] border border-[rgba(255,255,255,0.1)] rounded-3xl p-8 transition-transform hover:-translate-y-2 h-full flex flex-col justify-between">
            <div>
              ...
              <ul className="space-y-4 mb-8">
                {inclusions.map((inc, i) => (
                  <li key={i} className="flex items-center gap-3 text-white/90 font-light">
          ...
          <div className="rv d3 relative bg-gradient-to-br from-[var(--deep)] to-[var(--abyss)] border border-[var(--cyan)] rounded-3xl p-10 transform md:scale-105 shadow-[0_0_40px_rgba(0,212,255,0.15)] h-[105%] flex flex-col justify-between z-10">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[var(--cyan)] to-[var(--aqua)] text-black font-bold uppercase tracking-wider text-xs px-4 py-1.5 rounded-full shadow-[0_0_15px_var(--cyan)] flex gap-1 items-center">
              ⭐ Most Popular
            </div>
            <div>
              <h3 className="heading-font text-3xl text-white mb-2 font-bold drop-shadow-md">Weekend Entry</h3>
              <p className="text-sm text-[var(--cyan)] mb-6">Sat-Sun &amp; Holidays per person</p>
              <div className="flex items-baseline gap-1 mb-8">
                <span className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-[var(--cyan)] drop-shadow-md">₹699</span>
                <span className="text-[var(--cyan)]">/person</span>
              </div>
              <ul className="space-y-4 mb-8">
                {inclusions.map((inc, i) => (
                  <li key={i} className="flex items-center gap-3 text-white font-medium">
                    <svg className="w-6 h-6 text-[var(--aqua)] drop-shadow-[0_0_5px_var(--aqua)]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" /></svg>
                    {inc}
                  </li>
                ))}
                <li className="flex items-center gap-3 text-[var(--gold)] font-medium">
                  <svg className="w-6 h-6 text-[var(--gold)] drop-shadow-[0_0_5px_var(--gold)]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" /></svg>
          ...
          {/* Group Tier */}
          <div className="rv d4 bg-gradient-to-br from-[var(--abyss)] to-[var(--deep)] border border-[rgba(255,209,102,0.3)] rounded-3xl p-8 transition-transform hover:-translate-y-2 h-full flex flex-col justify-between">
            <div>
        ...
        {/* Fine Print */}
        <div className="mt-16 text-center text-[var(--muted)] text-sm max-w-3xl mx-auto rv d4 border-t border-[rgba(255,255,255,0.05)] pt-8 space-y-2 font-light">
          ...
          <p className="mt-6 text-xs text-white/40 italic">* Prices may vary on special occasions or festivals.</p>
        </div>
